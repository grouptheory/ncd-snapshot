...
public class MyJiggleSettings extends Dialog implements ActionListener {

	public static final long serialVersionUID = 1L;

	MyJiggle parent = null;
	...
	public MyJiggleSettings (MyJiggle p, int x, int y) {
		super (p, "Settings", true);
                parent = p;
